...
class TColor {
  ...
  static Color get blue => const Color(0xff0047AB);         // Deep Blue
  static Color get blue500 => const Color(0xff0066CC);      // Medium Blue
  static Color get blue100 => const Color(0xff1069FF);
  static Color get blue50 => const Color(0xff2A71FE);         // Medium Blue
  static Color get blue30 => const Color.fromARGB(255, 42, 103, 244);     // Sky Blue
  static Color get blue20 => const Color(0xff3399FF);     // Sky Blue
  static Color get blue10 => const Color(0xff66B2FF);       // Lighter Blue
  static Color get blue5 => const Color(0xff99CCFF);        // Very Light Blue
  static Color get blue0 => const Color(0xffCCE5FF);        // Pale Blue
  ...
  static Color get secondaryG20 => const Color(0xff62f8a6);
